...
#include <stdlib.h>
#include "ros/msg.hpp"
#include "cartographer_ros_msgs/TrajectoryOptions.hpp"
#include "cartographer_ros_msgs/SensorTopics.hpp"
...
static const char STARTTRAJECTORY[] = "cartographer_ros_msgs/StartTrajectory";
  ...
  class StartTrajectoryRequest : public ros::Msg
  {
    ...
    const char * getMD5(){ return "2fbdca45b91af2953d6ce571d83e0ab6"; };
