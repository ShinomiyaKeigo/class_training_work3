#include "layer_application/execute_function.hpp"	//ver1.5
#if EXECUTE_FUNCTION_ENABLE
using namespace std;

static_assert(EXECUTE_FUNCTION==1.5,"Execute_function version does not match. Check the latest version of the file on github.(ExecuteFunctionクラスのcppとhppのバージョンが一致しません。githubで最新バージョンのファイルを確認してください。)");
